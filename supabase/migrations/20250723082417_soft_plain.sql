/*
  # Fix session assignment and creation issues

  1. Database fixes
    - Fix enrollment constraints
    - Update session capacity logic
    - Fix RLS policies
    - Clean up existing data conflicts

  2. Session management
    - Fix session ID generation
    - Remove duplicate constraints that cause issues
